...
const PLAYLIST = [
  new PlaylistItem(
    "titre",
    "http://192.168.43.131:8000/media/audio/message_audio/audio_gLHHgwS.mp3",
    false
  ),
  new PlaylistItem(
    "Tsara tsodrano dadah",
    "http://192.168.43.131:8000/media/audio/message_audio/Dadah_Tsara_tso-drano.mp3",
    false
  ),
  new PlaylistItem(
    "Tsara tsodrano dadah",
